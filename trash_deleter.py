...
B = 20
limit = 100
links = {"группа": "https://vk.com/public195140206", "мод": "https://steamcommunity.com/sharedfiles/filedetails/?id=212491.."}
...
#                second_name = user_get['second_name']
                	...
                	try:
                    	...
                    	vk_session.method("messages.send", {"chat_id": 53, "message": f"Удалил сообщение {user_id}", "random_id": 0})
                	except Exception:
                    	continue
